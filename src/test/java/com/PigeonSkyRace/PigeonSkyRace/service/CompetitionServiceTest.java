...
public class CompetitionServiceTest {
    ...
    public void testCreateCompetition() {
        List<Breeder> breeders = Arrays.asList(
                new Breeder("Breeder1", "email1@example.com", "GPS1"),
                new Breeder("Breeder2", "email2@example.com", "GPS2"));
...
public void testCloseCompetition() {
    // Arrange
    PigeonResults pigeonResults = new PigeonResults("Comp1", "Pigeon1", LocalTime.of(12, 0));
    ...
    pigeon.setBreeder("Breeder1"); // Set the breeder ID

    Breeder breeder = new Breeder("Breeder1", "email1@example.com", "34.0522,-118.2437");
    ...
    public void testCalcFlightTime_NegativeDuration() {
        ...
        PigeonResults pigeonResults = new PigeonResults("Comp1", "Pigeon1", LocalTime.of(9, 0));
    ...
    public void testCalcDistance() {
        ...
        Breeder breeder = new Breeder("Breeder1", "email1@example.com", "34.0522,-118.2437"); // Valid GPS coordinates
